...
void rotate(double* p_triangles, double triangles[triangle_count][3][3], double angle, int terminal_x, int terminal_y, int terminal_z)
{
    ...
    double z_array[3][3] = 
    {
        {cos(angle + z_angle_offset),  -sin(angle + z_angle_offset),    0},
        {sin(angle + z_angle_offset),  cos(angle + z_angle_offset),     0},
        {0,           0,              1}
    };

    double y_array[3][3] = 
    {
        {cos(angle + y_angle_offset),    0,          sin(angle + y_angle_offset)  },
        {0,             1,          0           },
        {-sin(angle + y_angle_offset),   0,          cos(angle + y_angle_offset)  }
    };

    double x_array[3][3] = 
    {
        {1,             0,          0},
        {0,             cos(angle + z_angle_offset), -sin(angle + z_angle_offset)},
        {0,             sin(angle + z_angle_offset), cos(angle + z_angle_offset)}
    };
